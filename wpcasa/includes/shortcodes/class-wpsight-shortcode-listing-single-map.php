...
class WPSight_Shortcode_Listing_Single_Map {

	/**
	 * Constructor
	 */
	public function __construct() {		
		add_shortcode( 'wpsight_listing_map', array( $this, 'shortcode_listing_single_map' ) );
	}
	 ...
	 * @since 1.0.0
	 */
	public function shortcode_listing_single_map( $atts ) {
		...
		return apply_filters( 'wpsight_shortcode_listing_map', $output, $atts );

	}

}

new WPSight_Shortcode_Listing_Single_Map();
