...
function wpsight_listing_query_vars() {
	...
	$vars = array_merge(
		(array) wpsight_listing_query_vars_general(),
		(array) wpsight_listing_query_vars_details(),
		(array) wpsight_listing_query_vars_taxonomies()
	);
...
/**
 * wpsight_listing_query_vars_general()
 *
...
add_filter( 'init', 'wpsight_listing_query_vars_general' );

function wpsight_listing_query_vars_general() {
	global $wp;
...
/**
 * wpsight_listing_query_vars_details()
 *
...
add_filter( 'init', 'wpsight_listing_query_vars_details' );

function wpsight_listing_query_vars_details() {
	global $wp;
...
/**
 * wpsight_listing_query_vars_taxonomies()
 *
...
function wpsight_listing_query_vars_taxonomies() {
