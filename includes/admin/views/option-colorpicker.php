...
?>
  ...
  <div class="wpsight-settings-field wpsight-settings-field-<?php echo esc_attr( $option_type ); ?>">
      <input type="text" name="<?php echo esc_attr( $option_id ); ?>" id="setting-<?php echo esc_attr( $option_css ); ?>" value="<?php echo esc_attr( $value ); ?>" class="wpsight-settings-colorpicker"/>
  </div>
