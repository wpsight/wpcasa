...
<?php } else { ?>
    ...
    <a href="<?php echo admin_url( '/admin.php?page=wpsight-licenses' ) ?>" target="_blank" class="button button-secondary button-text-icon"><span class="dashicons dashicons-cloud"></span><?php _e( 'Activate', 'wpcasa' ) ?></a>
<?php } ?>